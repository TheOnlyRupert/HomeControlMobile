...
public class SettingsPageVm : INotifyPropertyChanged {
    ...
    public bool IsLocallyHosted {
        ...
        set {
            Preferences.Set(nameof(IsLocallyHosted), value);
            OnPropertyChanged();
        }
    }
    ...
    public bool IsDatabaseHosted {
        ...
        set {
            Preferences.Set(nameof(IsDatabaseHosted), value);
            OnPropertyChanged();
        }
    }
    ...
    public string DatabaseHost {
        ...
        set {
            Preferences.Set(nameof(DatabaseHost), value);
            OnPropertyChanged();
        }
    }
    ...
    public string DatabaseUsername {
        ...
        set {
            Preferences.Set(nameof(DatabaseUsername), value);
            OnPropertyChanged();
        }
    }
    ...
    public string DatabasePassword {
        ...
        set {
            Preferences.Set(nameof(DatabasePassword), value);
            OnPropertyChanged();
        }
    }
    ...
    public string User1Name {
        ...
        set {
            Preferences.Set(nameof(User1Name), value);
            OnPropertyChanged();
        }
    }
    ...
    public string User2Name {
        ...
        set {
            Preferences.Set(nameof(User2Name), value);
            OnPropertyChanged();
        }
    }
    ...
    public string User3Name {
        ...
        set {
            Preferences.Set(nameof(User3Name), value);
            OnPropertyChanged();
        }
    }
    ...
    public string User4Name {
        ...
        set {
            Preferences.Set(nameof(User4Name), value);
            OnPropertyChanged();
        }
    }
    ...
    public string User5Name {
        ...
        set {
            Preferences.Set(nameof(User5Name), value);
            OnPropertyChanged();
        }
    }
